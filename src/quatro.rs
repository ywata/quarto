        ...
        for s in Shape::iter() {
            for t in Top::iter() {
                for h in Height::iter() {
                    pieces.push(Piece {color:c.clone(), shape:s.clone(), top:t.clone(), height:h.clone()});
                }
            }
        }
    }
...
impl Board {
    ...
    fn count_elements<S: Clone + Eq + PartialEq + Hash>(&self, coords: &Vec<(usize, usize)>, prop: fn(Piece)->S) -> (bool, usize) {
    ...
    pub fn parse_quatro(self, coords_vec: Vec<Vec<(usize, usize)>>) ->  Vec<(Vec<(usize, usize)>, ((bool, usize), (bool, usize), (bool, usize), (bool, usize)))> {
        let mut ret: Vec<(Vec<(usize, usize)>, ((bool, usize), (bool, usize), (bool, usize), (bool, usize)))> = Vec::new();
        for coords in coords_vec {
            ...
            let quatro = (color_count.clone(), shape_count.clone(), height_count.clone(), top_count.clone());
...
mod test {
    ...
    fn test_parse_all_pieces() {
        ...
        let expected = vec![
            vec![
                Some(Piece{color: Color::Brown, height:Height::Short, shape: Shape::Circle, top: Top::Flat,}),
                Some(Piece{color: Color::Brown, height:Height::Short, shape: Shape::Circle, top: Top::Hole,}),
                Some(Piece{color: Color::Brown, height:Height::Short, shape: Shape::Square, top: Top::Flat,}),
                Some(Piece{color: Color::Brown, height:Height::Short, shape: Shape::Square, top: Top::Hole,}),
            ],
            vec![
                Some(Piece{color: Color::Brown, height:Height::Tall, shape: Shape::Circle, top: Top::Flat,}),
                Some(Piece{color: Color::Brown, height:Height::Tall, shape: Shape::Circle, top: Top::Hole,}),
                Some(Piece{color: Color::Brown, height:Height::Tall, shape: Shape::Square, top: Top::Flat,}),
                Some(Piece{color: Color::Brown, height:Height::Tall, shape: Shape::Square, top: Top::Hole,}),

            ],
            vec![
                Some(Piece{color: Color::White, height:Height::Short, shape: Shape::Circle, top: Top::Flat,}),
                Some(Piece{color: Color::White, height:Height::Short, shape: Shape::Circle, top: Top::Hole,}),
                Some(Piece{color: Color::White, height:Height::Short, shape: Shape::Square, top: Top::Flat,}),
                Some(Piece{color: Color::White, height:Height::Short, shape: Shape::Square, top: Top::Hole,}),

            ],
            vec![
                Some(Piece{color: Color::White, height:Height::Tall, shape: Shape::Circle, top: Top::Flat,}),
                Some(Piece{color: Color::White, height:Height::Tall, shape: Shape::Circle, top: Top::Hole,}),
                Some(Piece{color: Color::White, height:Height::Tall, shape: Shape::Square, top: Top::Flat,}),
                Some(Piece{color: Color::White, height:Height::Tall, shape: Shape::Square, top: Top::Hole,}),
    ...
    fn test_empty_board() {
        ...
        let board = Board::parse_board_text(&board_text.to_string());
        let expected = vec![
            vec![Some(Piece{color: Color::Brown, height:Height::Short, shape: Shape::Circle, top: Top::Flat,}), None, None, None],
